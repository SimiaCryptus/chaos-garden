...
export const SCHEMA = {
  ...
  flow:      { type: 'number', min: -3, max: 3, default: 1, step: 0.05, label: 'Flow rate U₀ (signed)',
  ...
  topology:  { type: 'enum', values: ['channel', 'torus'], default: 'channel', label: 'Streamwise topology',
...
export const SHORT_KEYS = { H: 'H', Re: 'R', flow: 'f', topology: 'o', inflow: 'i', spanwise: 's', walls: 'w', seed: 'd', tier: 't', backend: 'g', twin: 'T', inkBudget: 'b', perturb: 'p' };
