...
export class Lyapunov {
  constructor({ delta0 = 1e-6, Tr = 32, window = 16 } = {}) {
    this.delta0 = delta0;
    this.Tr = Tr;
    this.window = window;
    this.reset();
  ...
  get lambda() {
    ...
    let s = 0;
    for (const x of this.samples) s += x;
